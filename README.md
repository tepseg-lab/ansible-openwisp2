...
- hosts: tepseg
  ...
  vars:
    ...
    tepseg_github_shared_ssh_private_key: "~/.ansible/roles/tepseg_ab.openwisp2/templates/github_ssh/id_rsa"
    tepseg_github_shared_ssh_public_key: "~/.ansible/roles/tepseg_ab.openwisp2/templates/github_ssh/id_rsa.pub"
